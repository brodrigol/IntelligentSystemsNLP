...
When you run the code the emotion from the data sets in this URL is used to train and test a model. This model predicts the emotion conveyed by the each tweet. 
As an output, the program returns a confusion matrix and a series of statistics regarding the performance of the model.
